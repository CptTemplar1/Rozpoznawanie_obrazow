...
import cv2
import numpy as np
from PyQt5.QtWidgets import QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QFileDialog
...
class Screen1(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('Rozpoznawanie rasy psa - Ekran 1')
    ...
    def chooseImage(self):
        ...
        if fname:
            ...
            self.label_image.setPixmap(
                pixmap.scaled(299, 299, Qt.KeepAspectRatio, Qt.SmoothTransformation))  # przeskaluj do 299x299
